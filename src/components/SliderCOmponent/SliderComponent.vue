    ...
    <div class="header__container">
      ...
      <div class="header__info">
        ...
        <div class="header__info_vidio">
          <img src="@/assets/Home/video.png" alt="Video">
          <img class="header__info_play" src="@/assets/Home/Exclude.svg" alt="Exclude">
        </div>
      </div>
